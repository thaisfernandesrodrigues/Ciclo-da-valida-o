/* Quando a página carregar, inicia tudo (novo conceito aprendido) */
window.onload = function() {
    ...
    /* parte usual do moranguinho */ 
    /* utilizando PVector do ProcessingJS, um pouco do q foi estudado na semana (*/
    var morango = {
        pos: { x: 300, y: 200 },    /* Posição no "mapa" */
        vel: { x: 2.5, y: 1.8 },     /* Velocidade (anda sozinho) */
        tamanho: 30,                  /* Tamanho do morango */
        validacao: 0                 /* Porcentagem de validação (começa em 0) */
    };
    
    /* Desenhando o moranguinho */
    function desenharMorango(x, y, tam) {
        ctx.save();
        ctx.translate(x, y);
        
        /* Sombra suave pro morango */
        ctx.shadowColor = 'rgba(200, 50, 50, 0.2)';
        ctx.shadowBlur = 15;
        ctx.shadowOffsetY = 3;
        
        /* Desenhando o morango, parte que precisei de ajuda universitária kkkkk */
        ctx.beginPath();
        ctx.moveTo(0, -tam);
        ...
        /* Cores e detalhes para q fique com um visual mais "robusto" */
        ...
        /* Sementinhas do morango (q tb achei uma parte mais dificilzinha) */
        var sementes = [
            [-8, -6], [8, -6],
            [-12, 2], [0, 0], [12, 2],
            [-8, 10], [8, 10],
    ...
    /* Função q atualiza o movim.*/
    function atualizarMorango() {
        /* Move o morango de acordo com a veloc. */
        morango.pos.x += morango.vel.x;
        morango.pos.y += morango.vel.y;
        
        /* Verifica se bateu nas bordas e faz um movim. de "voltar"/quicar */
    ...
    /* Função q mostra as infos na tela */
